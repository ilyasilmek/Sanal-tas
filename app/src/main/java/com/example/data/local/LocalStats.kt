...
interface StatsDao {
    ...
    @Query("UPDATE local_stats SET unsynced_clicks = unsynced_clicks + :amount, last_updated = :timestamp WHERE id = 1")
    suspend fun addUnsyncedClicks(amount: Long, timestamp: Long = System.currentTimeMillis())
}
